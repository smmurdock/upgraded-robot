# Cheatsheet: Section 4: Operations with Data Types
...
# In a list, the 2nd, 3rd, and 4th items can be access with
...
# A single dictionary can be accessed using its key:
